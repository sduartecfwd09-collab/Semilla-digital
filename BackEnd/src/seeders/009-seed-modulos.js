...
module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('modulos', [
      ...
      { id: 4,  clave: 'ferias',         nombre: 'Gestión de Ferias',         descripcion: 'Administración de ferias del agricultor',          icono: '🏪', orden: 4, created_at: new Date(), updated_at: new Date() },
      ...
      { id: 6,  clave: 'puestos',        nombre: 'Puestos de Agricultor',     descripcion: 'Gestión de puestos en ferias',                    icono: '🏕️', orden: 6, created_at: new Date(), updated_at: new Date() },
