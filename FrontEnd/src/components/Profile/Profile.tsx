      ...
      .then(json => {
        ...
        if (json) {
          ...
          if (userRequests.length > 0) {
            const agRequests = userRequests.filter((r: any) => r.rol_solicitado === 'Productor' || r.rolSolicitado === 'Productor' || r.rol_solicitado === 'Agricultor' || r.rolSolicitado === 'Agricultor');
