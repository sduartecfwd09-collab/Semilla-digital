...
const Configuracion: React.FC = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      // Actualizar el contexto de auth (usa la clave 'user' internamente).
      // Antes se escribía 'auth_user', que no estaba sincronizado con nada.
      updateUserInContext({
        nombre: profileData.nombre,
        ...
        <div className="admin-content">
          ...
          <div className="config-card">
            ...
            <div className="config-card-body">
              ...
              {/*aquí deberá ir el botón en el que el Productor pueda cambiar su contraseña */}
