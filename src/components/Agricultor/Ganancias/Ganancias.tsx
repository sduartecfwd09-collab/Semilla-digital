...
const Ganancias: React.FC = () => {
  ...
  const exportPDF = () => {
    ...
    doc.setFontSize(10);
    doc.text(
      `Agricultor: ${(user as any)?.nombre || (user as any)?.email || "N/A"}`,
      14,
      28,
    );
    ...
    <>
      ...
      <div className="admin-layout">
        ...
        <div className="admin-main">
          ...
          <section
            className="ganancias-section"
            style={{ border: "1px solid #efe7d5" }}
          >
            <div className="ganancias-section-header">
              <div>
                <h3 className="ganancias-section-title">
                  Ingredientes Activos más Costosos
                </h3>
                <p className="ganancias-section-description">
                  Ingredientes activos con mayor inversión en tu producción.
                </p>
              </div>
              <button className="export-btn" title="Exportar ingredientes">
                <span>Exportar</span>
              </button>
            </div>
                  ...
                  option={{
                    tooltip: {
                      ...
                      formatter: (params: any[]) => {
                        const d = chartData[params[0].dataIndex];
                        return `<b>${d.nombre}</b><br/>
                              Costo Total: ${currencyFormatter.format(
                                d.costoEst * d.cantidad,
                              )}<br/>
                              Ganancia Neta: ${currencyFormatter.format(d.totalNeto)}<br/>
                              Margen: ${d.margenPct.toFixed(1)}%`;
                      },
              ...
              <div className="pie-empty-state" style={{ minHeight: "300px" }}>
                Selecciona una categoría para ver los ingredientes activos
              </div>
            )
          </section>
        </div>
