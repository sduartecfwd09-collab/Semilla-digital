...
const AdminPrecios = () => {
    ...
    const [priceToDelete, setPriceToDelete] = useState<MergedPrice | null>(null)
    ...
    const fetchPrices = async () => {
        try {
            ...
            const mergedPrices: MergedPrice[] = pricesData.map((p: Price) => {
    ...
    const handleDeleteClick = (priceItem: MergedPrice) => {
